     ...
     <main>
         ...
         <section class="home" id="home">
             <div class="content">
                 ...
                 <a href="#" class="boton boton__agenda"><i class="fa-solid fa-calendar-days"></i> Agendar cita
                 </a>
             </div>
         </section>
                 ...
                 <div class="tipcontainer">
                     ...
                     <div class="tip">
                         ...
                         <div class="content">
                             ...
                             <p>Usa cepillos con cerdas naturales. Son muy comunes las cerdas de jabalí, pues el cabello
                     ...
                     <div class="tip">
                         ...
                         <div class="content">
                             ...
                             <p>Si quieres evitar la caída de tu cabello y prevenir la resequedad, además de utilizar
                                 tratamientos anticaída, también debes enjuaga tu pelo después del lavado con agua fría,
                                 sobre todo si tu pelo es fino. El agua fría promueve más el brillo una vez secado.</p>
                         </div>
                     </div>
                 ...
                 <div class="tipcontainer">
                     <div class="tip">
                         ...
                         <div class="content">
                             ...
                             <p>Necesitas lucir perfecta después de una noche de fiesta o simplemente después de dormir
                     ...
                     <div class="tip">
                         ...
                         <div class="content">
                             ...
                             <p>Para mejorar un cabello visiblemente graso, usa talco. Muchas veces alguna urgencia
                                 impide lavar el cabello con tiempo. Si es tu caso, aplica un poco de talco a las cerdas
                     ...
                     <div class="tip">
                         ...
                         <div class="content">
                             ...
                             <p>Las uñas son la carta de presentación de las manos. Por eso deben lucir limpias y sanas.
                                 Aplica limón antes de dormir, tus uñas estarán siempre limpias y fuertes para los días
             ...
             <div class="about__content">
                 ...
                 <div class="about__container container">
                     ...
                     <section class="about__body" data-id="4">
                         <div class="about__texts">
                             <h2 class="subtitle">Mi nombre es Mauricio Campos, <span class="about__course">estudiante
                                     de
                                     ADSO.</span></h2>
                             <p class="about__review">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ut est
                                 esse, niam laboriosam saepe reiciendis dolorem. Cum, ratione voluptatum!</p>
             ...
             <div class="servicecontent">
                 ...
                 <div class="services">
                     ...
                     <div class="services__texts services__texts--3">
                         ...
                         <p class="services__paragraph" id="descripcionservice"> Regálate un momento de lujo para tu
                             piel. ✨
